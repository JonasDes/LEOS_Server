...
exports.keywordRouter = router;
// CREATE
router.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const keyword = new keyword_model_1.default(req.body);
        yield keyword.save();
...
router.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const keyword = yield keyword_model_1.default.find().populate('vehicles');
...
//# sourceMappingURL=keyword%20copy.js.map